    ...
    dropdown: [
      {
        ...
        offeredServices: [
          ...
          { label: "Backend Development", icon: "📝" },
      ...
      },
      {
        ...
        offeredServices: [
          ...
          { label: "React Native Development", icon: "🔄" },
      ...
      },
      {
        ...
        techStack: [
          ...
          { label: "GCP ", icon: "🟦" },
          { label: "IBM Cloud ", icon: "🔷" },
          { label: "Oracle Cloud", icon: "🔷" },
          { label: "Serverless Computing", icon: "🔷" },
          { label: "Virtual Machines", icon: "🔷" },
          { label: "Cloud Databases", icon: "🔷" },
      ...
      },
      {
        ...
        techStack: [
          ...
          { label: "Salesforce Lightning Experience", icon: "🅰️" },
          { label: "Visualforce", icon: "👁️" },
          { label: "Salesforce Integration", icon: "👁️" },
          { label: "Salesforce Customization", icon: "👁️" },
          { label: "Salesforce Mobile SDK", icon: "👁️" },
          { label: "Salesforce Data Loader", icon: "👁️" },
          { label: "Salesforce App Exchange Apps", icon: "👁️" },
        ]
      },
      {
        title: "CI/CD DevOps",
        offeredServices: [
          { label: "Cloud DevOps Services", icon: "🔗" },
          { label: "AWS Devops Services", icon: "📈" },
          { label: "GCP Devops Services", icon: "🤖" },
